...
public class LogicController {
	...
	private void processServicesByType(AttributeType type,
			ServiceProcessorCallback callbackProcessor) {
		List<InternalEntitiesServiceWrapper> serviceWrapperList = entitiesContiner
				.getInternalEntitiesByAttributeService(type);
