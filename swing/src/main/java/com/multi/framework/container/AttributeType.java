...
public enum AttributeType {
	...
	LISTEN(Listen.class, ListenService.class, DefaultDeafService.class), SEE(
			See.class, SeeService.class, DefaultBlindService.class), THINK(
			Think.class, ThinkService.class, DefaultDumbSerivce.class), EVOLVE(
			Evolve.class, EvolveService.class, DefaultImmutableService.class), MOVE(
			Move.class, MoveService.class, DefaultStillService.class), SPEAK(
			Speak.class, SpeakService.class, DefaultSilentService.class);
	...
	public static AttributeType getTypeByServiceInterface(
			Class<? extends AttributeService> interfaceClass) {
		for (AttributeType type : AttributeType.values()) {
